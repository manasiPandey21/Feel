const catalog = [
    ...
    },
    {
      ...
      story: `Just keep moving my friend, just keep moving. If you stopped now then things will only get worse. I know this time is very hard for you, all you want to do is to lie down on your bed 24*7 and cry for hours, screaming at your pillow and thinking about all those things that makes your life hell. But always keep one thing in your mind, Life is a battle that we fought everyday, every fuc*king second, and you can't let Sadness wins this. I myself were in depression for like a year, after my breakup. Maybe i am depressed right now. But one thing is very clear, that it will always get better, if you try your hardest. Share you feelings with others, make yourself comfortable with the person you trust the most. But, just don't make yourself isolated in your own world. Go out, meet new people, visit new places, spend time with your friends, more time with your family, try to see all those good things that's still left in your life, be thankful for that. Trust me these things will really help you on finding the new perspective of your life.`
    },
    {
      id: 4,
      heading: 'Am I Normal?',
      story: 'Wondering if your thoughts and feelings are normal? It\'s normal to feel like that, we are here to help you. Explore this category to gain insights and perspectives on common experiences.'
    },
    {
      id: 5,
      heading: 'Am I Normal?',
